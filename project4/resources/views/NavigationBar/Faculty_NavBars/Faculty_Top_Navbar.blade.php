            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header">3
                            Notifications</span>
                ...
                <div id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="click"
                    ...
                    <div class="info m-auto">
                        <a href="#" class="d-block text-maroon text-bold">Irynne
                            Gatchalian</a>
                ...
                <div id="dropdownHover" class="z-10 hidden pal-1 divide-y divide-gray-100 rounded-lg shadow w-44">
                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownHoverButton">
                        <li>
                            <a href="faculty_profile.html" class="block px-4 py-2 text-white">Profile</a>
                        </li>
                        <li>
