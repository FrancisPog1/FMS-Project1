                                        ...
                                        @foreach ($specializations as $specialization)
                                            <tr>
                                                ...
                                                <form method="POST" action="{{ route('delete_specializations', $specialization->id) }}">
                                                    ...
                                                    <button data-toggle="modal" onclick="openViewModal('{{ $specialization->title }}', '{{ $specialization->description }}')" data-target="#modal-xl-view" type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View</button>
                                                    <button type="button" onclick="openEditModal('{{ $specialization->title }}', '{{ $specialization->description }}',  '{{ $specialization->id }}')" class="px-3 py-2 text-sm font-medium text-center text-white bg-yellow-400 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Edit</button>
