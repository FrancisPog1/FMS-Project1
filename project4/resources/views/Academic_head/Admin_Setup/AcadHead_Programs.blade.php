...
@section('content')  
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <button data-toggle="modal" data-target="#modal-xl-create" type="button" class="px-4 py-2 text-sm font-medium text-center text-white bg-green-800 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">Create New Program</button>
                                </div>
                            </div>
                                    ...
                                    @foreach ($programs as $program)
                                            <tr>
                                                ...
                                                <form method="POST" action="{{ route('delete_programs', $program->id) }}">
                                                    ...
                                                    <button data-toggle="modal" onclick="openViewModal('{{ $program->title }}', '{{ $program->description }}')" data-target="#modal-xl-view" type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">View</button>
                                                    <button type="button" onclick="openEditModal('{{ $program->title }}', '{{ $program->description }}',  '{{ $program->id }}')" class="px-3 py-2 text-sm font-medium text-center text-white bg-yellow-400 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300">Edit</button>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close" data-dismiss="modal" id="Edit_cancelButton" aria-label="Close">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        <button type="button" class="btn btn-outline-danger" id="Edit_closeModalButton" data-dismiss="modal">Close</button>
    ...
    <script>
        function openEditModal(title, description, programId) {
            ...
            document.getElementById('editForm').action = "{{ route('update_programs', '') }}" + programId;
