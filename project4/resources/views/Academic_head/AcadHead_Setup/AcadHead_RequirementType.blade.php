                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <button data-toggle="modal" data-target="#modal-xl-create" type="button" class="px-4 py-2 text-sm font-medium text-center text-white bg-green-800 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Create New Requirement Type</button>
                                </div>
                            </div>
                                    ...
                                    @foreach ($requirementtypes as $requirementtype)
                                            <tr>
                                                ...
                                                <form method="POST" action="{{ route('delete_requirementtypes', $requirementtype->id) }}">
                                                    ...
                                                    <button data-toggle="modal" onclick="openViewModal('{{ $requirementtype->title }}', '{{ $requirementtype->description }}')" data-target="#modal-xl-view" type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View</button>
                                                    <button type="button" onclick="openEditModal('{{ $requirementtype->title }}', '{{ $requirementtype->description }}',  '{{ $requirementtype->id }}')" class="px-3 py-2 text-sm font-medium text-center text-white bg-yellow-400 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Edit</button>
