                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach ($requirementbins as $requirementbin)
                                            <tr>
                                                ...
                                                <button data-toggle="modal" onclick="openViewModal('{{ $requirementbin->title }}', '{{ $requirementbin->description }}', '{{ $requirementbin->deadline}}', '{{ $requirementbin->status }}') " type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View</button>
                                                <button type="button" onclick="openEditModal('{{ $requirementbin->title }}', '{{ $requirementbin->description }}',  '{{ $requirementbin->id }}', '{{ $requirementbin->deadline}}', '{{ $requirementbin->status }}') " class="px-3 py-2 text-sm font-medium text-center text-white bg-yellow-400 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Edit</button>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close" data-dismiss="modal" id="View_cancelButton" aria-label="Close">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" tabindex="1" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label>Description</label>
                                                    <textarea type="text" class="form-control" id="description" name="description" tabindex="1" style="height: 100px;" readonly></textarea>
                                                </div>
                                            </div>
											...
											<div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="deadline" name="deadline" placeholder="Title" tabindex="1" readonly>
											</div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="status" name="status" tabindex="1" readonly>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <button type="button" class="btn btn-outline-danger" id="View_closeModalButton" data-dismiss="modal">Close</button>
                                </div>
                            <!-- /.modal-content -->
                            </div>
                            <!-- /.modal-dialog -->
