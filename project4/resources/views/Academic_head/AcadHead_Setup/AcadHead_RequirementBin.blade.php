                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach ($requirementbins as $requirementbin)
                                            <tr>
                                                ...
                                                <button data-toggle="modal" onclick="openViewModal('{{ $requirementbin->title }}', '{{ $requirementbin->description }}', '{{ $requirementbin->deadline}}', '{{ $requirementbin->status }}') " type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">View</button>
