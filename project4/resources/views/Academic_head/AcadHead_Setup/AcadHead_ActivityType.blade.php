                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <button data-toggle="modal" data-target="#modal-xl-create" type="button" class="px-4 py-2 text-sm font-medium text-center text-white bg-green-800 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">Create New Activity Type</button>
                                </div>
                            </div>
                                        ...
                                        @foreach ($activitytypes as $activitytype)
                                            <tr>
                                                ...
                                                <form method="POST" action="{{ route('delete_activitytypes', $activitytype->id) }}">
                                                    ...
                                                    <button data-toggle="modal" onclick="openViewModal('{{ $activitytype->title }}', '{{ $activitytype->description }}', '{{ $activitytype->category }}')" data-target="#modal-xl-view" type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">View</button>
                                                    <button type="button" onclick="openEditModal('{{ $activitytype->title }}', '{{ $activitytype->description }}', '{{ $activitytype->category }}' ,'{{ $activitytype->id }}')" class="px-3 py-2 text-sm font-medium text-center text-white bg-yellow-400 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300">Edit</button>
