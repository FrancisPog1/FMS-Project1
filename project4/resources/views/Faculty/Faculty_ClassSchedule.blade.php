                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                                ...
                                <div class="row mt-7 ">
                                    <div class="col-md-12">
                                        <div class="card card-primary">
                                            <form>
                                                <div class="card-header">
                                                    <label class="">Add Proof of attendance</label>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label class="required-input">Date</label>
                                                            <input type="text" class="form-control" id="Dae" name="Dae"
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6 additional-input">
                                                            ...
                                                            tabindex="1" value="" min="" data-parsley-excluded="true">
                                                        </div>
                                                        <div class="form-group col-md-6 additional-input">
                            ...
                            <div class="modal-footer
                                ...
                                <button type="button" class="btn btn-primary text-col-1">Create</button>
                            </div>
                        </div>
                    </div>
                </div>
